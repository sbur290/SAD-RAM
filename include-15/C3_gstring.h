/* =============================================================================
    File: pico_gstring.h. Version 7.0.0.2. Nov 20, 2012.
...
#ifndef _PICO_GSTRING_H_INCLUDED_
#define _PICO_GSTRING_H_INCLUDED_
...
class cGString
   {public:
       ...
       int              Find         (const char* subStrP, int offset = 0) const;
       int              Break        (const char* breakersP, int offset = 0) const;
...
#endif // _PICO_GSTRING_H_INCLUDED_ ...
